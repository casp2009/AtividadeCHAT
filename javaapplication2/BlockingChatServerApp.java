...
public class BlockingChatServerApp {
            ...
            while((msg = clientSocket.getMessage()) != null){
                switch (msg.charAt(0)) {
                    case '!':
                        ...
                        msg = "o Cliente "+nome+" Entrou no CHAT";
                    ...
                    case '@':
                        ...
                        sendMsgToOne(clientSocket, msg.substring(count+1, msg.length()), nome);
                        break;
                    default:
                        sendMsgToAll(clientSocket, msg);   
                        break;
                ...
                //System.out.println("Mensagem recebida do cliente "+ clientSocket.nome +": " + msg);
    ...
    private void sendMsgToOne(final ClientSocket sender, final String msg, final String nome) {
        final Iterator<ClientSocket> iterator = clientSocketList.iterator();
        int count = 0;
        ...
        System.out.println("Mensagem encaminhada para " + nome);
    }
